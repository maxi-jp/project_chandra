...
namespace IS_XNA_Shooter
{
    class GameStoryFinalDemo : Game
    {
        ...
        public GameStoryFinalDemo(SuperGame mainGame, GRMng grManager, Audio audio, XMLLvlMng LvlMng,
            ...
            : base(mainGame, player, evolution)
        {
            ...
            LvlMng.LoadContent("Dialogs2"); // Load the dialogs
            ...
            try
            {
                ...
                switch (level)
                {
                    case 0:
                        Talk talk;
                        int i = 1;
                        XmlDocument dialog = XMLLvlMng.xmlDialogs2;
        ...
        private void PlaySong(String cad)
        {
            switch (cad)
            {
                ...
                case "LevelBFinalBoss": Audio.PlayMusic(4); break;
